...
<html>
<head>
  <title>Women's Sneakers | DeeReel Footies</title>
  <?php include($_SERVER['DOCUMENT_ROOT'] . '/components/header.php'); ?>
  <?php include($_SERVER['DOCUMENT_ROOT'] . '/components/navbar.php'); ?>
</head>
<body data-page="women-sneakers">
  ...
  <main>   
    <div class="max-w-7xl mx-auto px-4 py-8">
      <!-- Breadcrumb -->
      <div class="mb-8">
        <h1 class="text-3xl font-light mb-2">WOMEN'S SNEAKERS COLLECTION</h1>
    ...
    <div class="block md:hidden sticky top-16 z-40 bg-white border-b px-4 py-2 overflow-x-auto whitespace-nowrap space-x-3 flex shadow-sm clean-scroll">
      ...
      <button onclick="filterByType('fashion')" data-type="fashion" class="type-filter inline-block px-4 py-2 border rounded text-sm font-medium hover:bg-gray-100">
        Fashion
      </button>
      <button onclick="filterByType('fitness')" data-type="fitness" class="type-filter inline-block px-4 py-2 border rounded text-sm font-medium hover:bg-gray-100">
        Fitness
      </button>
    </div>
      ...
      <div class="md:w-1/4 space-y-6">
        ...
        <div class="mb-6">
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <div class="w-6 h-6 rounded-full cursor-pointer border border-gray-300 color-filter" style="background-color: #ec4899;" data-color="pink"></div>
