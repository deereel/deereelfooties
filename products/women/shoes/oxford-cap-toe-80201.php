...
<head>
  ...
  <title>Oxford Cap Toe 80201 | Handcrafted Luxury Shoes for Men and Women</title>
...
<body>
  ...
  <header class="sticky-top bg-white border-bottom shadow-sm">
    ...
    <nav class="d-lg-none">
      <button class="btn btn-outline-secondary w-100 mb-2" type="button" data-bs-toggle="collapse" data-bs-target="#mobileMenu" aria-controls="mobileMenu" aria-expanded="false" aria-label="Toggle navigation">
        ☰ Menu
      </button>
      ...
      <div class="collapse" id="mobileMenu">
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="/men.php" data-bs-toggle="dropdown" aria-expanded="false">MEN</a>
            <ul class="dropdown-menu">
              <li class="dropdown-submenu">
                <a class="dropdown-item dropdown-toggle" href="/products/men/men-shoes.php">Shoes</a>
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="/products/men/men-loafers.php">Loafers</a></li>
                  <li><a class="dropdown-item" href="/products/men/men-oxford.php">Oxford</a></li>
                  <li><a class="dropdown-item" href="/products/men/men-derby.php">Derby</a></li>
                  <li><a class="dropdown-item" href="/products/men/men-monk.php">Monk Straps</a></li>
                </ul>
              </li>
              <li class="dropdown-submenu">
                <a class="dropdown-item dropdown-toggle" href="/products/men/men-boots.php">Boots</a>
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="/products/men/men-zipper-boots.php">Zipper boots</a></li>
                  <li><a class="dropdown-item" href="/products/men/men-wingtip-boots.php">Wingtip boots</a></li>
                  <li><a class="dropdown-item" href="/products/men/men-chelsea-boots.php">Chelsea boots</a></li>
                  <li><a class="dropdown-item" href="/products/men/men-captoe-boots.php">Captoe boots</a></li>
                  <li><a class="dropdown-item" href="/products/men/men-jodhpur-boots.php">Jodhpur boots</a></li>
                  <li><a class="dropdown-item" href="/products/men/men-balmoral-boots.php">Balmoral boots</a></li>
                </ul>
              </li>
          ...
          <!-- WOMEN -->
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="/women.php" data-bs-toggle="dropdown" aria-expanded="false">WOMEN</a>
            <ul class="dropdown-menu">
              <li class="dropdown-submenu">
                <a class="dropdown-item dropdown-toggle" href="/products/women/women-shoes.php">Shoes</a>
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="/products/women/women-loafers.php">Loafers</a></li>
                  <li><a class="dropdown-item" href="/products/women/women-oxford.php">Oxford</a></li>
                  <li><a class="dropdown-item" href="/products/women/women-derby.php">Derby</a></li>
                  <li><a class="dropdown-item" href="/products/women/women-monk.php">Monk Straps</a></li>
                </ul>
              </li>
              <li class="dropdown-submenu">
                <a class="dropdown-item dropdown-toggle" href="/products/women/women-boots.php">Boots</a>
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="/products/women/women-zipper-boots.php">Zipper boots</a></li>
                  <li><a class="dropdown-item" href="/products/women/women-wingtip-boots.php">Wingtip boots</a></li>
                  <li><a class="dropdown-item" href="/products/women/women-chelsea-boots.php">Chelsea boots</a></li>
                  <li><a class="dropdown-item" href="/products/women/women-captoe-boots.php">Captoe boots</a></li>
                  <li><a class="dropdown-item" href="/products/women/women-jodhpur-boots.php">Jodhpur boots</a></li>
                  <li><a class="dropdown-item" href="/products/women/women-balmoral-boots.php">Balmoral boots</a></li>
                </ul>
              </li>
          ...
          <!-- Size guide -->
          <li class="nav-item">
            <a class="nav-link" href="/size-guide.php">SIZE GUIDE</a>
          </li>
      ...
      <div class="d-flex align-items-center gap-4">
            ...
            <div class="dropdown position-relative">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="/products/men/men-men-slippers.php">Slippers/Sandals</a></li>
                  <li><a class="dropdown-item" href="/products/men/men-men-mules.php">Mules</a></li>
                </ul>
            </div>
            ...
            <div class="dropdown position-relative">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="/products/women/women-/products/women/women-slippers.php">Slippers/Sandals</a></li>
                  <li><a class="dropdown-item" href="/products/women/women-/products/women/women-mules.php">Mules</a></li>
                </ul>
            </div>
