...
<head>
  ...
  <title>Penny Loafer W80647 - DeeReeL Footies</title>
  ...
  <header class="sticky top-0 z-50 w-full transition-all duration-200 bg-white">
    ...
    <div class="flex items-center justify-between px-4 py-4 border-b">
      ...
      <nav class="hidden md:flex items-center space-x-8">
        ...
        <a href="../../moo.php" class="hover:underline">MTO</a>
        <a href="../..//products.php" class="hover:underline">OUTLET SHOES</a>
      </nav>
      ...
      <div class="flex items-center space-x-4">
        <a href="../../search.php" class="hover:text-gray-600">
          <i class="fas fa-search"></i>
          <span class="sr-only">Search</span>
        </a>
        <a href="../..//shoemaking.php" class="hidden md:block hover:underline">SHOEMAKING</a>
        <a href="../..//cart.php" class="hover:text-gray-600">
          <div class="relative">
    ...
    <div class="mobile-menu md:hidden bg-white absolute w-full z-50 border-b hidden">
      <nav class="flex flex-col p-4 space-y-4">
        <a href="../../men.php" class="py-2 border-b">MEN</a>
        <a href="../../women.php" class="py-2 border-b">WOMEN</a>
        <a href="../../customize.php" class="py-2 border-b">CUSTOMIZE</a>
        <a href="../../moo.php" class="py-2 border-b">MTO</a>
        <a href="../..//products.php" class="py-2 border-b">OUTLET SHOES</a>
        <a href="../..//shoemaking.php" class="py-2 border-b">SHOEMAKING</a>
        <a href="../..//contact.php" class="py-2 border-b">CONTACT</a>
        <a href="../../our-history.php" class="py-2 border-b">OUR HISTORY</a>
        <a href="../../blog.php" class="py-2">BLOG</a>
      </nav>
    </div>
  </header>
