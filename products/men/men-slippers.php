...
<body class="bg-background" data-page="men-slippers">
=======

<body data-page="men-slippers">
>>>>>>> parent of f36b17c (checkout page)
  ...
  <main>
    <div class="max-w-7xl mx-auto px-4 py-8">
      <!-- Breadcrumb -->
      <div class="mb-8">
        <h1 class="text-3xl font-light mb-2">MEN'S SLIPPERS / SANDALS COLLECTION</h1>
        <div class="flex items-center text-sm text-gray-500">
          <a href="/index.php">Home</a>
          <span class="mx-2">/</span>
          <a href="/men.php">Men</a>
          <span class="mx-2">/</span>
          <span>Slippers/Sandal</span>
        </div>
      </div>
