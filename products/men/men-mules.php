...
<html>
<head>
  <title>Men's Mules | DeeReel Footies</title>
  <?php include($_SERVER['DOCUMENT_ROOT'] . '/components/header.php'); ?>
  <?php include($_SERVER['DOCUMENT_ROOT'] . '/components/navbar.php'); ?>
</head>

<body data-page="men-mules">
  ...
  <main>   
    <div class="max-w-7xl mx-auto px-4 py-8">
      <!-- Breadcrumb -->
      <div class="mb-8">
        <h1 class="text-3xl font-light mb-2">MEN'S MULES COLLECTION</h1>
      ...
      <!-- Mobile-only Inner Filter for Mule Types -->
    <div class="block md:hidden sticky top-16 z-40 bg-white border-b px-4 py-2 overflow-x-auto whitespace-nowrap space-x-3 flex shadow-sm clean-scroll">
      <button onclick="filterByType('classic')" data-type="classic" class="type-filter inline-block px-4 py-2 border rounded text-sm font-medium hover:bg-gray-100">
        Classic Mules
      </button>
      <button onclick="filterByType('backless')" data-type="backless" class="type-filter inline-block px-4 py-2 border rounded text-sm font-medium hover:bg-gray-100">
        Backless Loafers
      </button>
