...
<head>
  ...
  <title>Vintage Croc 600 | Handcrafted Luxury Shoes for Men and Women</title>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="border mb-3">
            <img id="mainImage" src="/images/Vintage Croc 600.webp" class="img-fluid w-100" alt="Main Shoe Image">
          </div>
      
          <!-- Thumbnail Gallery -->
          <div class="d-flex flex-row flex-wrap gap-2">
            <img src="/images/Vintage Croc 600.webp" class="img-thumbnail thumb" style="width: 80px; cursor: pointer;" onclick="changeImage(this)">
            <img src="/images/Vintage Croc 600-1.webp" class="img-thumbnail thumb" style="width: 80px; cursor: pointer;" onclick="changeImage(this)">
            <img src="/images/Vintage Croc 600-2.webp" class="img-thumbnail thumb" style="width: 80px; cursor: pointer;" onclick="changeImage(this)">            
          </div>
        </div>
      
        <div class="col-md-6">
          <!-- Product Info -->
          <h3 class="fw-bold">Vintage Croc 600</h3>
          <p class="text-muted">Premium handcrafted mules for elegant occasions.</p>
          <ul class="list-disc pl-5 mb-4 text-gray-600">
            <li>Premium Crocskin upper</li>
            <li>Leather lining and insole</li>            
            <li>Black colored rubber sole</li>
            <li>Made in Lagos, Nigeria</li>
          </ul>
          <p class="text-2xl mb-4">₦35,000</p>
          ...
          <div class="border-t pt-6 space-y-4">
            <details class="group">
              ...
              <div class="pt-4 pb-2 text-gray-600">
                <p>
                  The Vintage Croc 600 is a quintessential dress shoe that embodies timeless elegance and superior craftsmanship. Featuring a sleek silhouette with a cap toe design, this Oxford is handcrafted in our workshop in Mallorca using traditional techniques that have been perfected over generations.
                </p>
                <p class="mt-2">
                  The premium crocskin leather develops a beautiful patina over time, making each pair uniquely yours. The Goodyear welt construction ensures durability and allows for resoling, making this an investment piece that will last for years with proper care.
                </p>
              </div>
            </details>
            ...
            <details class="group border-t pt-4">
              ...
              <div class="pt-4 pb-2 text-gray-600">
                <ul class="list-disc pl-5">
                  <li>Last: Inca</li>                  
                  <li>Upper: Premium Crocskin leather</li>
                  <li>Lining: Full leather</li>
                  <li>Sole: Black-colored rubber</li>
