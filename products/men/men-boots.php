...
<<<<<<< HEAD
<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/auth/db.php'); ?><body class="bg-background" data-page="men-boots">
=======

<body data-page="men-boots">
>>>>>>> parent of f36b17c (checkout page)
  ...
  <main>
    <div class="max-w-7xl mx-auto px-4 py-8">
      <!-- Breadcrumb -->
      <div class="mb-8">
        <h1 class="text-3xl font-light mb-2">MEN'S BOOTS COLLECTION</h1>
