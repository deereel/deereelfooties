...
<head>
  ...
  <title>Women Collections - DeeReel Footies | Handcrafted Luxury Shoes for Men and Women</title>
...
<body>
  ...
  <main>
    <div class="max-w-7xl mx-auto px-4 py-8">
      <div class="mb-8">
        <h1 class="text-3xl font-light mb-2">WOMEN'S COLLECTION</h1>
      ...
      <!-- Mobile-only Category Filter Bar for WOMEN -->
      <div class="block md:hidden sticky top-16 z-40 bg-white border-b px-4 py-2 overflow-x-auto whitespace-nowrap space-x-3 flex shadow-sm clean-scroll">
        <a href="/products/women/women-shoes.php?gender=women&type=all" data-cat="shoes" class="cat-filter inline-block px-4 py-2 border rounded text-sm font-medium hover:bg-gray-100">
          Shoes
        </a>
        <a href="/products/women/women-boots.php?gender=women&type=all" data-cat="boots" class="cat-filter inline-block px-4 py-2 border rounded text-sm font-medium hover:bg-gray-100">
          Boots
        </a>
        <a href="/products/women/women-slippers.php" data-cat="slippers" class="cat-filter inline-block px-4 py-2 border rounded text-sm font-medium hover:bg-gray-100">
          Slippers/Sandals
        </a>
        <a href="/products/women/women-mules.php" data-cat="mules" class="cat-filter inline-block px-4 py-2 border rounded text-sm font-medium hover:bg-gray-100">
          Mules
        </a>
      </div>
